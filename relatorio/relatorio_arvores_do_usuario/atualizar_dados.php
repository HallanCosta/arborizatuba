				...
				<form method="post">
					<?php foreach ($rows as $row): ?>
						<div class="form-group">
							...
							<input type="text" required name="cep" value="<?= $row->cep ?>" class="form-control" maxlength="9">
						</div>
						<div class="form-group">
							<label for=""><strong>*</strong>Tipo de Logradouro: </label>
							<input type="text" required name="tp_logradouro" value="<?= $row->tp_logradouro ?>" class="form-control" maxlength="8">
						</div>
						<div class="form-group">
							<label for=""><strong>*</strong>Logradouro: </label>
							<input type="text" required name="logradouro" value="<?= $row->logradouro ?>" class="form-control" maxlength="100">
						</div>
						<div class="form-group">
							<label for=""><strong>*</strong>Número da Rua: </label>
							<input type="text" required name="num" value="<?= $row->num ?>" class="form-control" maxlength="4">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" required name="bairro" value="<?= $row->bairro ?>" class="form-control" maxlength="30">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="date" required name="ultima_poda" value="<?= $row->ult_poda ?>" class="form-control" maxlength="10">
						</div>
						<div class="form-group">
						...
						<a href="index.php?page=1" class="btn btn-warning">Voltar</a>
