...
if (filter_input(INPUT_GET, 'txtPesquisaCEP', FILTER_SANITIZE_SPECIAL_CHARS) && filter_input(INPUT_GET, 'txtPesquisaCEP', FILTER_SANITIZE_SPECIAL_CHARS) != '' && filter_input(INPUT_GET, 'txtPesquisaCEP', FILTER_SANITIZE_SPECIAL_CHARS) != NULL) {
	$txtPesquisa = '%' . filter_input(INPUT_GET, 'txtPesquisaCEP', FILTER_SANITIZE_SPECIAL_CHARS) . '%';
} elseif(filter_input(INPUT_GET, 'txtPesquisaBairro', FILTER_SANITIZE_SPECIAL_CHARS) && filter_input(INPUT_GET, 'txtPesquisaBairro', FILTER_SANITIZE_SPECIAL_CHARS) != '' && filter_input(INPUT_GET, 'txtPesquisaBairro', FILTER_SANITIZE_SPECIAL_CHARS) != NULL){
	$txtPesquisa = '%' . filter_input(INPUT_GET, 'txtPesquisaBairro', FILTER_SANITIZE_SPECIAL_CHARS) . '%';
} elseif (filter_input(INPUT_GET, 'txtPesquisaEndereco', FILTER_SANITIZE_SPECIAL_CHARS) && filter_input(INPUT_GET, 'txtPesquisaBairro', FILTER_SANITIZE_SPECIAL_CHARS) != '' && filter_input(INPUT_GET, 'txtPesquisaBairro', FILTER_SANITIZE_SPECIAL_CHARS) != NULL){
	$txtPesquisa = '%' . filter_input(INPUT_GET, 'txtPesquisaEndereco', FILTER_SANITIZE_SPECIAL_CHARS) . '%';
}
							...
							<div class="form-inline">
								<div class="panel panel-info">
									...
									<div class="panel-body">
										...
										<!-- <input type="text" placeholder="Pesquisar por Bairro" id="txtPesquisaBairro" class="form-control input-lg">
											<input type="text" placeholder="Pesquisar por Endereco" id="txtPesquisaEndereco" class="form-control input-lg"> -->
